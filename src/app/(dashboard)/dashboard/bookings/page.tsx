...
export default async function DashboardBookingsPage() {
  ...
  return (
    <div className="page-transition">
      ...
      <BookingList items={pending} title="En attente" accentText={accentText} />
      <BookingList items={confirmed} title="Confirmés" accentText={accentText} />
      <BookingList items={other} title="Passés / Annulés" accentText={accentText} />
    </div>
  );
}
